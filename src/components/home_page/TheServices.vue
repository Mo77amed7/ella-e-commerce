<template>
  <div class="services">
    <div class="container-fluid">
      <div class="row">
        <div class="col" v-for="service in services" :Key="service.title">
          <div
            class="card border-0 text-center d-flex align-items-center justify-content-center"
          >
            <span v-html="service.img"></span>
            <div class="card-body">
    ...
    services: [
      {
        ...
        title: "Qauality And Saving",
        desc: "comprehensive quality control and offordable prices",
      },
      {
        ...
        title: "gobal warehouse",
        desc: "37 overses earehouse",
      },
      {
