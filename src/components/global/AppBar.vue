  ...
  >
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-6">
          <div class="search text-center">
            <input
              type="search"
              class="form-control d-inline-block rounded-pill py-2"
        ...
        <div class="col-2">
          <div class="contact" style="color: white">
            ...
            <span class="font-weight-bold">(090) 1234-567</span>
          </div>
        </div>
        <div class="col-2">
          <div
          ...
          >
            <div class="wish d-flex flex-column align-items-center">
              <svg
                viewBox="0 0 512 512"
                class="icon icon-wishlist mb-1"
                style="width: 30px; fill: #fec422"
              >
                <g>
                  <g>
                    <path
        ...
        C482,254.358,413.255,312.939,309.193,401.614z"
              ...
              <span style="color: #fec422">Wish Lists</span>
            </div>
            <div class="sign d-flex flex-column align-items-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink"
                class="icon icon-account mb-1"
            ...
            >
              ...
              <span
                class="position-absolute top-0 start-0 translate-middle bg-danger rounded-circle text-center"
                style="
                  width: 20px;
                  height: 20px;
                  color: white;
      ...
      <div class="row">
        <div class="col-8">
          <ul
            class="d-flex justify-content-between mt-4 p-0"
          ...
          >
            <div class="helpers d-flex align-items-center position-relative">
              <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 448 512"
                class="svg-inline--fa fa-user-headset fa-w-14 fa-2x mr-2"
                style="width: 20px"
              >
                <path
                  fill="blue"
              ...
              <span style="font-weight: bold; color: white; margin-left: 10px"
                >Help</span
              >
            </div>
            <div class="dropdown languages d-flex cursor-pointer">
              <select
                class="border-0"
                ...
                "
              >
                <option selected value="1" style="color: black !important">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    version="1.1"
                    x="0px"
                  ...
                  <span style="margin-left: 3px"
                    >{{ languages[0].title }} /
                    {{ languages[0].currency }}</span
                  >
                </option>
                <option value="2" style="color: black !important">
                  <span v-html="languages[1].icon"></span
                  ><span style="margin-left: 3px"
                    >{{ languages[1].title }} /
                    {{ languages[1].currency }}</span
                  >
                </option>
              </select>
            </div>
...
.helpers {
  &::after {
    ...
    width: 1px;
    height: 100%;
    background-color: rgba(255, 254, 254, 0.416);
  }
}
</style>
<script>
