  ...
  <div class="features p-3">
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col">
          <div
            class="parent second d-flex align-items-center justify-content-center"
          >
            <svg
              aria-hidden="true"
              focusable="false"
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 384 512"
              class="svg-inline--fa fa-award fa-w-12 fa-3x mr-2"
              style="width: 25px"
            >
              <path
                fill="currentColor"
        ...
        <div class="col">
          <div class="parent d-flex align-items-center justify-content-center">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 576 512"
              class="svg-inline--fa fa-trophy-alt fa-w-18 fa-3x mr-2"
              style="width: 25px"
            >
              <path
                fill="currentColor"
