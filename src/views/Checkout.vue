<template>
  <div class="checkout">
    <div class="container-fluid">
      <div class="row">
        <div class="col-7">
          <div style="width: 80%; margin-left: auto; padding-right: 20px">
            ...
            <div class="express-checkout" style="position: relative">
              <span
                style="
                  display: block;
                  text-align: center;
              ...
              <hr style="margin-top: 30px; background-color: #f5f5f5" />
            </div>
            <div class="contact" style="margin-top: 30px">
              ...
              <div style="display: flex; align-items: center">
                <input
                  ...
                  name=""
                  id="email"
                  style="border: 1px solid #ccc; margin-right: 8px"
                />
                <label for="email" style="font-size: 13px"
                  >Email with news and offers</label
                >
              </div>
            </div>
          </div>
          ...
          <div style="padding: 20px; width: 80%">
            ...
            >
              ...
              >
                ...
                <span
                  data-v-5b6fbb5e=""
                  class="position-absolute top-0 start-0 translate-middle bg-secondary rounded-circle text-center"
                  style="
                    width: 20px;
                    height: 20px;
                    color: white;
                  ...
                  >{{ item.quantity }}</span
                >
                <div class="title-parent" style="font-size: 16px">
            ...
            >
              ...
              />
              <button
                style="background-color: #eee; padding: 8px 12px; border: none"
              >
                Apply
              </button>
            </div>
            <div class="total" style="padding: 10px">
              <div
                style="
                  display: flex;
                  align-items: center;
              ...
              <div
                ...
                "
              >
                <span>Total</span><span>{{ totalItems + 20 }}$</span>
              </div>
            </div>
          </div>
        </div>
